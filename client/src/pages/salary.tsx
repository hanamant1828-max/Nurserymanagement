              ...
              {filteredSalaryData.length === 0 ? (
                ...
                filteredSalaryData.map((item) => (
                  <TableRow key={item.id} className="group hover:bg-muted/10 transition-colors">
                    ...
                    <TableCell className="py-4 text-center">
                      {item.advanceTaken > 0 ? (
                        <span className="inline-flex items-center bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 px-3 py-1 rounded-full text-sm font-bold">
            ...
            >
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  {item.advanceTaken > 0 && (
                    <span className="h-10 px-3 rounded-xl bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 text-xs font-semibold flex items-center gap-1">
                      Advance: ₹{item.advanceTaken.toLocaleString('en-IN')}
                    </span>
                  )}
                </div>
              </div>
