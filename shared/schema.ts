...
export const rolePermissions = pgTable("role_permissions", {
  id: integer("id").primaryKey().generatedAlwaysAsIdentity(),
  role: text("role").notNull(), // admin, staff, manager, etc.
  pagePath: text("page_path").notNull(), // e.g., "/orders", "/users"
...
export const categories = pgTable("categories", {
  ...
  pricePerUnit: text("price_per_unit").default("1.00").notNull(),
...
export const lots = pgTable("lots", {
  ...
  damagePercentage: text("damage_percentage").default("0.00"),
...
export const orders = pgTable("orders", {
  ...
  taluk: text("taluk"),
  perUnitPrice: text("per_unit_price").default("0.00").notNull(),
  bookedQty: text("booked_qty").notNull(),
  allocatedQuantity: text("allocated_quantity").default("0.00").notNull(),
  pendingQuantity: text("pending_quantity").notNull(),
  ...
  advanceAmount: text("advance_amount").notNull(),
  ...
  sowingDate: text("sowing_date"), // User input sowing date for pending lots
  actualDeliveryDate: text("actual_delivery_date"),
  actualDeliveryTime: text("actual_delivery_time"),
  deliveredQty: text("delivered_qty").default("0.00"),
